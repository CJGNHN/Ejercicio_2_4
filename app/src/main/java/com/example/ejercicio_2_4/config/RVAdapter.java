...
import com.example.ejercicio_2_4.R;
...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.RVViewHolderClass> {
    ...
    ArrayList<Signature> objectModelClassList;

    public RVAdapter(ArrayList<Signature> objectModelClassList) {
    ...
    public void onBindViewHolder(@NonNull RVViewHolderClass rvViewHolderClass, int i) {
        Signature objectModelClass=objectModelClassList.get(i);
        rvViewHolderClass.imageNameTV.setText(objectModelClass.getdescripcion());
